...
m = folium.Map(location=[26.5844, 73.8496],zoom_start=10, tiles='cartodbpositron')
...
# Reading ac data
geo_ac_data = gpd.read_file("raj_ac.geojson")
districts = list(geo_ac_data['DIST_NAME'].unique())
...
# Creating dropdowns
category = st.sidebar.selectbox("Select a Category", list(df.columns[7:]))
...
if district == "All":
    ...
    if assembly_const == "None":
        ...
        dist_data = geo_ac_data[geo_ac_data['DIST_NAME'] == district]
